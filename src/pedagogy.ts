...
- import_image: After Grok Imagine or another host image tool returns a URL, call this to copy the file into our R2 cache and get an attachable hash. Optional subject is a label only; cache identity is the image bytes. HTTPS PNG/JPEG/GIF/WebP only. Use the returned URL; attach the hash only if they save a card.
